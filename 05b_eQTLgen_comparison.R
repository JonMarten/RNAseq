...
# correlate Z-scores
  jobdf$Zscore_correlation_all[i] <- cor(eSNP_replication$zscore, eSNP_replication$eQTLgen_Zscore_flipped)
  jobdf$Zscore_correlation_sig[i] <- cor(eSNP_replication$zscore[which(eSNP_replication$sig_bonf_sign == 1)],
