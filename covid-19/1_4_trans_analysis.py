...
# Function to re-add RSids as these are no longer in the vcf file for chr x
...
#x_trans_df2 = add_rsid(x_trans_df, rsid)
#x_trans_df2["rsid"][x_trans_df2["rsid"] == "."] = x_trans_df2["variant_id"][x_trans_df2["rsid"] == "."]
#x_trans_df2["variant_id"] = x_trans_df2["rsid"]
#x_trans_df2 = x_trans_df2.drop(columns = ["rsid", "pheno_id"])
