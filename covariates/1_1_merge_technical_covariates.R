...
techCovsPhase2 <- fread("raw/INTERVAL_RNA_Covariates_Ph2_27-03-2020.csv", data.table = F)
...
fwrite(techCovsAll, "processed/INTERVAL_RNA_technical_covariates_batch1-12_20200402.csv")
